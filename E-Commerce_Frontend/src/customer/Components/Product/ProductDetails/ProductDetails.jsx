            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl tracking-tight text-gray-900 mt-6">
                <p className="font-semibold">
                  {customersProduct.product?.discountedPrice}DH
                </p>
                <p className="opacity-50 line-through">
                  {customersProduct.product?.price}DH
                </p>
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 text-sm">250 Ratings</p>
              ...
              <Grid item xs={5}>
                ...
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">100</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">70</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
                  ...
                  >
                    ...
                    <Grid xs={2}>
                      <p className="opacity-50 p-2">50</p>
                    </Grid>
                  </Grid>
                </Box>
                <Box>
